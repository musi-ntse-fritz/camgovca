...
// You can add dynamic PHP content in the sections below as needed
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<style>
		* {
		...
		.flag {
			width: 40px;
			height: 30px;
			background: linear-gradient(to right, #007a3d 0% 33.33%, #ce1126 33.33% 66.66%, #fcd116 66.66% 100%);
			border-radius: 3px;
		...
		<div class="container">
			<div class="top-nav-content">
				<ul class="header-links">
					...
					<li><a href="contact-info.php">Our Contacts</a></li>
				</ul>
	...
	<header class="main-header">
		<div class="container">
			<div class="header-content">
				<div class="logo-left">
					<img style="width:70px; height:70px; object-fit:contain;" src="camgovca.cm\public\logo.jpeg" alt="antic logo">
				</div>
				...
				<div class="logo-right">
					<img style="width:70px; height:70px;" src="camgovca.cm\public\logo2.png" alt="Caut of arm logo">
				</div>
			</div>
		</div>
	</header>
				...
				<ul class="main-nav-links">
					<li class="dropdown">
						...
						<div class="dropdown-content">
							<a href="message-du-directeur-general.php">Mot du DG</a>
							<a href="missions-pki.php">Missions de la PKI</a>
							<a href="organigramme.php">Organigramme du centre</a>
						</div>
					</li>
					<li class="dropdown">
						<a href="about.php">Généralités de la PKI</a>
						<div class="dropdown-content">
							<a href="le-livre-blanc.php">Livre blanc de la PKI</a>
							<a href="ca-fr.php">Autorité de certification</a>
							<a href="about.php">Autorité d'enregistrement</a>
							<a href="about.php">Autorité d'horodatage</a>
							<a href="about.php">OCSP</a>
							<a href="about.php">Algorithmes de sécurité</a>
						</div>
					</li>
					<li class="dropdown">
						<a href="communiques.php">Actualités</a>
						<div class="dropdown-content">
							<a href="communiques.php">Communiqués de presse</a>
							<a href="communiques.php">Événements</a>
							<a href="communiques.php">Médiathèque</a>
						</div>
					</li>
					<li class="dropdown">
						<a href="services-et-produits.php">Services and Products</a>
						<div class="dropdown-content">
					...
					<li class="dropdown">
						<a href="demande-de-certificats-fr.php">Obtain Certificate</a>
						<div class="dropdown-content">
							<a href="administration-fr.php">Administration</a>
							<a href="entreprise.php">Entreprise</a>
							<a href="individu-fr.php">Individu</a>
						</div>
					</li>
					<li><a href="operator.php">Operator</a></li>
					<li class="dropdown">
						<a href="operations.php">Operations on Certificates</a>
						<div class="dropdown-content">
							<a href="emettre-certificat.php">Émettre un certificat</a>
							<a href="remettre-certificat.php">Remettre un certificat</a>
							<a href="changer-mot-passe-certificat.php">Changer le mot de passe d'un certificat</a>
							<a href="suspendre-certificat.php">Suspendre un certificat</a>
							<a href="revoquer-certificat.php">Révoquer un certificat</a>
							<a href="copier-certificat.php">Copier un certificat</a>
							<a href="renouveler-certificat.php">Renouveler un certificat</a>
							<a href="verifier-identite-certificat.php">Vérifier le numéro d'identité d'un certificat</a>
							<a href="verifier-certificat.php">Vérifier un certificat</a>
							<a href="lister-certificats-revoques.php">Lister les certificats révoqués</a>
							<a href="lister-autorites-certificats-revoques.php">Lister les autorités de certificats révoqués</a>
						</div>
					</li>
					<li class="dropdown">
						<a href="reglementation-politique.php">Regulations and Policies</a>
						<div class="dropdown-content">
							<a href="charte-d-abonnement.php">Charte d'abonnement</a>
							<a href="lois-et-reglements.php">Lois et Règlements</a>
							<a href="politique-de-certificats.php">Déclaration des pratiques de certification</a>
						</div>
					</li>
				</ul>
			</div>
			...
			<div class="slider" id="slider">
				...
				<div class="slide">
					<div class="slide-content">
						...
						<a href="demande-de-certificats-fr.php" class="slide-button">Obtenir un certificat</a>
					</div>
				</div>
				...
				<div class="slide">
					<div class="slide-content">
						...
						<a href="services-et-produits.php" class="slide-button">Learn More</a>
					</div>
				</div>
				...
				<div class="slide">
					<div class="slide-content">
						...
						<a href="services-list.php" class="slide-button">Explore Services</a>
					</div>
				</div>
				...
				<div class="slide">
					<div class="slide-content">
						...
						<a href="services-list.php" class="slide-button">Get Started</a>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="welcome-section">
				<div class="welcome-left">
					...
					<a href="demande-de-certificats-fr.php" class="certificate-button">
