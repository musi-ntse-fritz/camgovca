...
<head>
    ...
    <title>Demande de Certificats - CamGovCA (Version Simplifiée)</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <nav class="nav">
        <div class="container">
            <ul>
                ...
                <li><a href="demande-de-certificats-fr-simple.php">Demande de Certificat</a></li>
        ...
        <div class="container">
            <div class="form-container">
                <div class="form-title">
                    ...
                    <p>Formulaire simplifié pour la demande de certificats CamGovCA</p>
                </div>
