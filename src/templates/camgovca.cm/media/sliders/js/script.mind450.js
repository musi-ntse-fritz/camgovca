...
var id=$link.attr('href').substr($link.attr('href').indexOf('#')+1);if(id==''){return;}var scroll=false;var $anchor=$('a[data-toggle="collapse"][data-id="'+id+'"]');if(!$anchor.length){$anchor=$('#'+id+',a[name="'+id+'"]');if(!$anchor.length){return;}
scroll=true;}
$anchor=$anchor.first();if(!$anchor.closest('.rl_sliders').length){return;}
